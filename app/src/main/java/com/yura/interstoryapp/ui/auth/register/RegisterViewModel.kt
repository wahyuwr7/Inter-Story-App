...
class RegisterViewModel : ViewModel() {
    fun register(name : String, email: String, password: String, context: Context): LiveData<Boolean>{
        val isRegistered = MutableLiveData<Boolean>()
        val service = ApiConfig.getApiService()

        service.register(name, email, password).enqueue(object : Callback<RegisterAndUploadResponse> {
